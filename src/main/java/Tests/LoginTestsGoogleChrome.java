...
import Configuration.DefaultTestConfigurationGoogleChrome;
...
public class LoginTestsGoogleChrome extends DefaultTestGoogleChrome // Location parameter: id, name, className, relative xpath;
{
    ...
    @AfterMethod
    public void tearDown() {DefaultTestConfigurationGoogleChrome.logOut();
    }
